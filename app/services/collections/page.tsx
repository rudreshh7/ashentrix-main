      ...
      <section className="bg-gradient-to-br from-[#280b57] to-[#1a0a3e] text-white py-20">
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Collections Services</h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional debt collection and recovery services that maintain
              customer relationships while maximizing collection rates through
