  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      results: ["40% efficiency increase", "60% cost reduction", "99.9% accuracy improvement"],
    ...
    },
    {
      ...
      solution: "Automated workflow systems and intelligent document processing",
      results: ["5x faster onboarding", "85% error reduction", "90% customer satisfaction"],
    ...
    },
    {
      ...
      results: ["95% inventory accuracy", "$2M cost savings", "30% faster delivery"],
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Real transformations, measurable results. See how we&apos;ve helped organizations achieve operational excellence.
          </p>
        </div>
